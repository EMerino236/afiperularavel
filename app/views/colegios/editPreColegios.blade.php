...
@section('content')
	...
	{{ Form::open(array('url'=>'colegios/submit_create_colegio', 'role'=>'form')) }}
		...
		<div class="row">
			<div class="form-group col-xs-5 @if($errors->first('nombre')) has-error has-feedback @endif">
				{{ Form::label('nombre','Nombre') }}
				{{ Form::text('nombre',$precolegio_info->nombre,array('class'=>'form-control','readonly' => 'true')) }}
			</div>

			<div class="form-group col-xs-5 @if($errors->first('direccion')) has-error has-feedback @endif">
				{{ Form::label('direccion','Dirección') }}
				{{ Form::text('direccion',$precolegio_info->direccion,array('class'=>'form-control','readonly' => 'true')) }}
			</div>
		</div>
		<div class="row">
			<div class="form-group col-xs-5 @if($errors->first('nombre_contacto')) has-error has-feedback @endif">
			...
			<div class="form-group col-xs-5 @if($errors->first('email_contacto')) has-error has-feedback @endif">
		...
		<div class="row">
			<div class="form-group col-xs-5 @if($errors->first('telefono_contacto')) has-error has-feedback @endif">
			...
			<div class="form-group col-xs-5 @if($errors->first('interes')) has-error has-feedback @endif">
