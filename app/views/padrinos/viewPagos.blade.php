...
@section('content')
	...
	{{ Form::open(array('url'=>'padrinos/submit_aprove_pago', 'role'=>'form')) }}
		...
		<div class="col-xs-6">
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('comprobante')) has-error has-feedback @endif">
			...
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('nombre_padrino')) has-error has-feedback @endif">
					{{ Form::label('nombre_padrino','Nombres') }}
					{{ Form::text('nombre_padrino',$pago_data->nombres,array('class'=>'form-control','readonly' => 'true')) }}
				</div>
			</div>
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('apellidosp')) has-error has-feedback @endif">
					{{ Form::label('apellidosp','Apellido Paterno') }}
					{{ Form::text('apellidosp',$pago_data->apellido_pat,array('class'=>'form-control','readonly' => 'true')) }}
				</div>
			</div>
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('apellidosm')) has-error has-feedback @endif">
		...
		<div class="col-xs-6">
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('num_cuota')) has-error has-feedback @endif">
			...
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('monto')) has-error has-feedback @endif">
			...
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('vencimiento')) has-error has-feedback @endif">
			...
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('fecha_pago')) has-error has-feedback @endif">
					{{ Form::label('fecha_pago','Fecha Pago') }}
					{{ Form::text('fecha_pago',$pago_data->fecha_pago,array('class'=>'form-control','readonly' => 'true')) }}
				</div>
			</div>
			<div class="row">
				<div class="form-group col-xs-8 @if($errors->first('estado')) has-error has-feedback @endif">
