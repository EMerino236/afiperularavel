		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<input class="padrinos-parent" type="checkbox" name="permisos[]" value="4" @if($permisos_data && in_array("4",$permisos_data)) checked @endif disabled> Menú Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="18" @if($permisos_data && in_array("18",$permisos_data)) checked @endif disabled> Listar Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="19" @if($permisos_data && in_array("19",$permisos_data)) checked @endif disabled> Aprobar Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="20" @if($permisos_data && in_array("20",$permisos_data)) checked @endif disabled> Crear Reporte Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="21" @if($permisos_data && in_array("21",$permisos_data)) checked @endif disabled> Listar Reportes Padrinos<br>
			...
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<input class="concursos-child" type="checkbox" name="permisos[]" value="25" @if($permisos_data && in_array("25",$permisos_data)) checked @endif disabled> Crear Concurso<br>
						<input class="concursos-child" type="checkbox" name="permisos[]" value="26" @if($permisos_data && in_array("26",$permisos_data)) checked @endif disabled> Listar Concursos<br>
						<input class="concursos-child" type="checkbox" name="permisos[]" value="27" @if($permisos_data && in_array("27",$permisos_data)) checked @endif disabled> Crear Proyecto<br>
						<input class="concursos-child" type="checkbox" name="permisos[]" value="28" @if($permisos_data && in_array("28",$permisos_data)) checked @endif disabled> Listar Proyectos<br>
						<br>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<input class="colegios-child" type="checkbox" name="permisos[]" value="29" @if($permisos_data && in_array("29",$permisos_data)) checked @endif disabled> Crear Colegio<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="30" @if($permisos_data && in_array("30",$permisos_data)) checked @endif disabled> Listar Colegios<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="31" @if($permisos_data && in_array("31",$permisos_data)) checked @endif disabled> Aprobar Colegios<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="32" @if($permisos_data && in_array("32",$permisos_data)) checked @endif disabled> Registrar Niño<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="33" @if($permisos_data && in_array("33",$permisos_data)) checked @endif disabled> Listar Niños<br>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<input class="usuarios-child" type="checkbox" name="permisos[]" value="34" @if($permisos_data && in_array("34",$permisos_data)) checked @endif disabled> Crear Usuario<br>
						<input class="usuarios-child" type="checkbox" name="permisos[]" value="35" @if($permisos_data && in_array("35",$permisos_data)) checked @endif disabled> Listar Usuarios<br>
						<br>
						<br>
						<br>
					</div>
			...
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<input class="sistema-child" type="checkbox" name="permisos[]" value="36" @if($permisos_data && in_array("36",$permisos_data)) checked @endif disabled> Crear Perfil<br>
						<input class="sistema-child" type="checkbox" name="permisos[]" value="37" @if($permisos_data && in_array("37",$permisos_data)) checked @endif disabled> Listar Perfiles<br>
						<input class="sistema-child" type="checkbox" name="permisos[]" value="38" @if($permisos_data && in_array("38",$permisos_data)) checked @endif disabled> Listar Perfiles<br>
						<br>
						<br>
					</div>
				</div>
