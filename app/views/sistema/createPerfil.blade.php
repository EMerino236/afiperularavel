		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="18" @if(Input::old('permisos') && in_array("18",Input::old('permisos'))) checked @endif> Listar Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="19" @if(Input::old('permisos') && in_array("19",Input::old('permisos'))) checked @endif> Aprobar Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="20" @if(Input::old('permisos') && in_array("20",Input::old('permisos'))) checked @endif> Crear Reporte a Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="21" @if(Input::old('permisos') && in_array("21",Input::old('permisos'))) checked @endif> Listar Reportes a Padrinos<br>
						<input class="padrinos-child" type="checkbox" name="permisos[]" value="22" @if(Input::old('permisos') && in_array("22",Input::old('permisos'))) checked @endif> Ver Calendario de Pagos<br>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<input class="concursos-child" type="checkbox" name="permisos[]" value="25" @if(Input::old('permisos') && in_array("25",Input::old('permisos'))) checked @endif> Crear Concurso<br>
						<input class="concursos-child" type="checkbox" name="permisos[]" value="26" @if(Input::old('permisos') && in_array("26",Input::old('permisos'))) checked @endif> Listar Concursos<br>
						<input class="concursos-child" type="checkbox" name="permisos[]" value="27" @if(Input::old('permisos') && in_array("27",Input::old('permisos'))) checked @endif> Crear Proyecto<br>
						<input class="concursos-child" type="checkbox" name="permisos[]" value="28" @if(Input::old('permisos') && in_array("28",Input::old('permisos'))) checked @endif> Listar Proyectos<br>
						<br>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<input class="colegios-child" type="checkbox" name="permisos[]" value="29" @if(Input::old('permisos') && in_array("29",Input::old('permisos'))) checked @endif> Crear Colegio<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="30" @if(Input::old('permisos') && in_array("30",Input::old('permisos'))) checked @endif> Listar Colegios<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="31" @if(Input::old('permisos') && in_array("31",Input::old('permisos'))) checked @endif> Aprobar Colegios<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="32" @if(Input::old('permisos') && in_array("32",Input::old('permisos'))) checked @endif> Registrar Niño<br>
						<input class="colegios-child" type="checkbox" name="permisos[]" value="33" @if(Input::old('permisos') && in_array("33",Input::old('permisos'))) checked @endif> Listar Niños<br>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<input class="usuarios-child" type="checkbox" name="permisos[]" value="34" @if(Input::old('permisos') && in_array("34",Input::old('permisos'))) checked @endif> Crear Usuario<br>
						<input class="usuarios-child" type="checkbox" name="permisos[]" value="35" @if(Input::old('permisos') && in_array("35",Input::old('permisos'))) checked @endif> Listar Usuarios<br>
						<br>
						<br>
						<br>
					</div>
			...
			<div class="col-md-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<input class="sistema-child" type="checkbox" name="permisos[]" value="36" @if(Input::old('permisos') && in_array("36",Input::old('permisos'))) checked @endif> Crear Perfil<br>
						<input class="sistema-child" type="checkbox" name="permisos[]" value="37" @if(Input::old('permisos') && in_array("37",Input::old('permisos'))) checked @endif> Listar Perfiles<br>
